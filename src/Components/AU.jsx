...
import '../Styles.css'
import leaf from '../img/core-img/leaf.png'
import '../js'
import '../scss'
// import '../css'
...
{/* //  <!-- Preloader --> */}
    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                {/* <!-- Post Image --> */}
                <div class="slide-img bg-img" styles="background-image: url(img/bg-img/1.jpg);"></div>
            ...
            <div class="single-hero-post bg-overlay">
                {/* <!-- Post Image --> */}
                <div class="slide-img bg-img" styles="background-image: url(img/bg-img/2.jpg);"></div>
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            {/* <!-- Post Content --> */}
    ...
    {/* <!-- ##### Service Area Start ##### --> */}
    <section class="our-services-area bg-gray section-padding-100-0 mt-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    {/* <!-- Section Heading --> */}
        ...
        <div class="container-fluid">
            ...
            <div class="row alazea-portfolio">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design home-design wow fadeInUp" data-wow-delay="100ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/16.jpg);"></div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/17.jpg);"></div>
                    {/* <!-- Portfolio Hover Text --> */}
                    <div class="portfolio-hover-overlay">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden design wow fadeInUp" data-wow-delay="300ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/18.jpg);"></div>
                    {/* <!-- Portfolio Hover Text --> */}
                    <div class="portfolio-hover-overlay">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden office-design wow fadeInUp" data-wow-delay="400ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/19.jpg);"></div>
                    {/* <!-- Portfolio Hover Text --> */}
                    <div class="portfolio-hover-overlay">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design office-design wow fadeInUp" data-wow-delay="100ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/20.jpg);"></div>
                    {/* <!-- Portfolio Hover Text --> */}
                    <div class="portfolio-hover-overlay">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/21.jpg);"></div>
                    {/* <!-- Portfolio Hover Text --> */}
                    <div class="portfolio-hover-overlay">
                ...
                <div class="col-12 col-lg-6 single_portfolio_item home-design wow fadeInUp" data-wow-delay="300ms">
                    {/* <!-- Portfolio Thumbnail --> */}
                    <div class="portfolio-thumbnail bg-img" styles="background-image: url(img/bg-img/22.jpg);"></div>
                    {/* <!-- Portfolio Hover Text --> */}
                    <div class="portfolio-hover-overlay">
    ...
    <section class="subscribe-newsletter-area" styles="background-image: url(img/bg-img/subscribe.png);">
        <div class="container">
    ...
    {/* <!-- ##### Footer Area Start ##### --> */}
    <footer class="footer-area bg-img" styles="background-image: url(img/bg-img/3.jpg);">
        {/* <!-- Main Footer Area --> */}
